...
export const AWS_FIREHOSE_STREAM_NAME = "DendroFirehoseStream238";
export const AWS_S3_BUCKET_NAME = "dendro-s3-bucket-" + Math.random().toString(36).substring(2);
export const AWS_TIMESTREAM_DATABASE_NAME = "DendroTimestreamDB238";
export const AWS_IAM_ROLE_NAME ="dendro-s3-lambda-role238";
